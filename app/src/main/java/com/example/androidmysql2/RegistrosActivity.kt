...
class RegistrosActivity : AppCompatActivity() {
    ...
    fun cargarDatos(){
        val url = "http://192.168.56.1/android_mysql2/consulta.php?id=$id"
    ...
    fun eliminar(Vista: View){
        val url = "http://192.168.56.1/android_mysql2/borrar.php"
        procesoEnCola = Volley.newRequestQueue(this)
    ...
    fun editar(Vista: View){
        val url = "http://192.168.56.1/android_mysql2/editar.php"
        procesoEnCola = Volley.newRequestQueue(this)
